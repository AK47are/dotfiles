...
4. Any mention of a **code** file location **MUST** use `relative/path:line` (full relative path from current file, line optional), whether explicit or descriptive. Examples: `./src/utils/helpers.js`, `./routes/user.js:15`. Every time you cut corners, the user has to memorize the paths and dig through folders
